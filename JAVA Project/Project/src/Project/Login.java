...
int count = 1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 200, 40));

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Password");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 180, 40));
    ...
    try {
        ...
        pst = conn.prepareStatement("SELECT * FROM password WHERE Username=? AND Password=?");
        ...
        m.setVisible(true);}
            ...
            if(count==4){
                count=count+1;
                JOptionPane.showMessageDialog(this, "You re not An Admin");
                System.exit(0);
            }
