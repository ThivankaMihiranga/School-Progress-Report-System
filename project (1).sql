...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2024 at 07:16 PM
...
(1, 'Thivanka', 'Abeyasingha', '200123800947', '2001-08-25', 716341300, 'Nuwara Eliya', '1-B', 2007, 'Male', 'Sinhala', 'Maths', 'Environment', 'English', 'Religeon', 'Tamil'),
(2, 'Lawan ', 'Nisura', '2001345523988', '2000-11-28', 716598744, 'Ambewela', '2-A', 2007, 'Male', 'Sinhala', 'Maths', 'Environment', 'English', 'Religeon', 'Tamil');
...
('1 Thivanka Mihiranga', 7406789, 75, 'A', 81, 'A', 65, 'B', 75, 'A', 91, 'A', 85, 'A', 472, 78.666664),
('2 Lawan', 98874456, 87, 'A', 71, 'B', 64, 'C', 54, 'D', 44, 'W', 34, 'W', 354, 59);

-- --------------------------------------------------------

--
-- Table structure for table `removedpsectd`
--

CREATE TABLE `removedpsectd` (
  `SID` int(11) NOT NULL,
...
--
-- Dumping data for table `removedpsectd`
--

INSERT INTO `removedpsectd` (`SID`, `Fname`, `Lname`, `NIC`, `DOB`, `Tpno`, `Address`, `Class`, `Year`, `Gender`) VALUES
(1, 'Thivanka Mihiranga', 'Abeyasingha', '200123800947', '2001-08-25', 716341300, 'Nuwara Eliya ', '6-C', 2013, 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `removedpsintd`
--

CREATE TABLE `removedpsintd` (
  `SID` int(11) NOT NULL,
  `Fname` varchar(255) NOT NULL,
  `Lname` varchar(255) NOT NULL,
  `NIC` varchar(255) NOT NULL,
...
--
-- Table structure for table `removedpstd`
--

CREATE TABLE `removedpstd` (
  `SID` int(11) NOT NULL,
...
--
-- Dumping data for table `removedpstd`
--

INSERT INTO `removedpstd` (`SID`, `Firstname`, `Lastname`, `NIC`, `DOB`, `Tpno`, `Address`, `Class`, `Year`, `Gender`) VALUES
(1, 'Thivanka', 'Abeyasingha', '200123800947', '2001-08-25', 716341300, 'Nuwara Eliya', '1-B', 2007, 'Male'),
(2, 'Lawan', 'Nisura', '200134523988', '2001-11-22', 716445897, 'Nuwara Eliya ', '1-A', 2007, 'Male');
...
(1, 'Thivanka Mihiranga', 'Abeyasingha', '200123800947', '2001.08.25', 716341300, 'Nuwara Eliya', '6-C', 2012, 'Male', 'Sinhala', 'Maths', 'Science', 'History', 'English', 'Buddisum', 'Civic', 'Music', 'ICT'),
